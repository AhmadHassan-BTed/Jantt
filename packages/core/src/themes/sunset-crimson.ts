...
export const sunsetCrimsonTheme: ThemeDefinition = {
  ...
  vars: {
    ...
    "--jantt-border": "rgba(249, 115, 22, 0.28)",
    "--jantt-border-subtle": "rgba(249, 115, 22, 0.14)",
    "--jantt-border-strong": "rgba(249, 115, 22, 0.45)",
    "--jantt-text": "#FFF7ED",
    ...
    "--jantt-grid-line": "rgba(249, 115, 22, 0.15)",
    "--jantt-grid-row-line": "rgba(249, 115, 22, 0.10)",
