...
export const nordicFrostTheme: ThemeDefinition = {
  ...
  vars: {
    ...
    "--jantt-border": "rgba(56, 189, 248, 0.18)",
    "--jantt-border-subtle": "rgba(56, 189, 248, 0.08)",
    "--jantt-border-strong": "rgba(56, 189, 248, 0.35)",
    "--jantt-text": "#F0F9FF",
    ...
    "--jantt-grid-line": "rgba(56, 189, 248, 0.08)",
    "--jantt-grid-row-line": "rgba(56, 189, 248, 0.06)",
