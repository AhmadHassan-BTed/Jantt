...
export const midnightRoseTheme: ThemeDefinition = {
  ...
  vars: {
    ...
    "--jantt-border": "rgba(244, 63, 94, 0.28)",
    "--jantt-border-subtle": "rgba(244, 63, 94, 0.14)",
    "--jantt-border-strong": "rgba(244, 63, 94, 0.45)",
    "--jantt-text": "#FFF1F2",
    ...
    "--jantt-grid-line": "rgba(244, 63, 94, 0.15)",
    "--jantt-grid-row-line": "rgba(244, 63, 94, 0.10)",
